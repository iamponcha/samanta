...
//		}
	...
	public function import_settings(){
		$this->log('Import home page. '.$this->import_data['home_page'].' -- '.$this->get_real_page_id($this->import_data['home_page']));
		if(key_exists('home_page', $this->import_data)) {
			update_option('page_on_front', $this->get_real_page_id($this->import_data['home_page']));
